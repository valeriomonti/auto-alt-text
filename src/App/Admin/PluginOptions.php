                ...
                if ($translationApiKey && $translationEndpoint && $translationRegion):
                    ...
                    try {
                        ...
                        $azureConfig = new AzureConfig(
                            self::apiKeyAzureComputerVision(),
                            self::endpointAzureComputerVision(),
                            '',
                            '',
                            self::apiKeyAzureTranslateInstance(),
                            self::endpointAzureTranslateInstance(),
                            self::regionAzureTranslateInstance(),
                            self::languageAzureTranslateInstance()
                        );
                        $azureTranslator = new AzureTranslator($httpClient, $azureConfig);
                        $supportedLanguages = $azureTranslator->supportedLanguages();
