...
class Constants
{
    ...
    const AATXT_OPTION_FIELD_FRONTEND_ALT_TEXT = 'aatxt_frontend_alt_text';
    const AATXT_OPTION_FIELD_FRONTEND_OVERWRITE_ALT_TEXT = 'aatxt_frontend_overwrite_alt_text';
