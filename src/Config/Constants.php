...
class Constants
{
    ...
    const AATXT_OPTION_FIELD_TYPOLOGY = 'aat_typology';
    const AATXT_OPTION_FIELD_PROMPT_OPENAI = 'aat_prompt_openai';
    const AATXT_OPTION_FIELD_FALLBACK_PROMPT_OPENAI = 'aat_fallback_prompt_openai';
    const AATXT_OPTION_FIELD_FALLBACK_MODEL_OPENAI = 'aat_model_openai';
    const AATXT_OPTION_FIELD_API_KEY_OPENAI = 'aat_api_key_openai';
    const AATXT_OPTION_FIELD_API_KEY_AZURE_COMPUTER_VISION = 'aat_api_key_azure_computer_vision';
    const AATXT_OPTION_FIELD_API_KEY_AZURE_TRANSLATE_INSTANCE= 'aat_api_key_azure_translate_instance';
    ...
    const AATXT_OPTION_FIELD_ENDPOINT_AZURE_COMPUTER_VISION = 'aat_endpoint-azure-computer-vision';
    const AATXT_OPTION_FIELD_ENDPOINT_AZURE_TRANSLATE_INSTANCE = 'aat_endpoint-azure-translate-instance';
    const AATXT_OPTION_FIELD_REGION_AZURE_TRANSLATE_INSTANCE = 'aat-region-azure-translate-instance';
    const AATXT_OPTION_FIELD_LANGUAGE_AZURE_TRANSLATE_INSTANCE = 'aat-language-azure-translate-instance';
    ...
    const AATXT_LOG_ASH = 'aat_log_ash';
    const AATXT_LOG_RETENTION_DAYS = 7;
    const AATXT_LOGS_CLEANUP_EVENT = 'aat_logs_cleanup_event';
}